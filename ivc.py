...
def convert_dicom_to_nifti():
	...
	dcmn2niix_cmd     = ["dcm2niix", "-z", "y", "-x", "y", "-f", dcmn2niix_o_name, "-o", nifti_dir, input_dir]
...
def plot_mask_overlay(mask_file, niftii_file):
	...
	plot_roi(mask, head, draw_cross=False, title="Mask Overlays", output_file=overlay_image_file)
